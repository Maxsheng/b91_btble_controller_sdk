...
__INLINE void em_bt_frcntl_pack(int elt_idx, uint8_t fmwspatt, uint8_t txbsyen, uint8_t rxbsyen, uint8_t dnabort, uint8_t samen, uint8_t format)
{
    ...
    EM_BT_WR(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE,  ((uint16_t)fmwspatt << 12) | ((uint16_t)txbsyen << 10) | ((uint16_t)rxbsyen << 9) | ((uint16_t)dnabort << 8) | ((uint16_t)samen << 7) | ((uint16_t)format << 0));
}
...
__INLINE void em_bt_linkcntl_arbiter_en_setf(int elt_idx, uint8_t arbiter_en)
{
    ...
    EM_BT_WR(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000040)) | ((uint16_t)(arbiter_en&0x1) << 6));
}
...
__INLINE void em_bt_linkcntl_observer_en_setf(int elt_idx, uint8_t observer_en)
{
    ...
    EM_BT_WR(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000020)) | ((uint16_t)(observer_en&0x1) << 5));
}
...
__INLINE void em_bt_txrxcntl_pack(int elt_idx, uint8_t rxthr, uint8_t rxeir, uint8_t rxbcry, uint8_t rxcrypt, uint8_t stopmod, uint8_t nullflt, uint8_t txeir, uint8_t txbcry, uint8_t txcrypt)
{
    ...
    EM_BT_WR(EM_BT_TXRXCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE,  ((uint16_t)rxthr << 13) | ((uint16_t)rxeir << 11) | ((uint16_t)rxbcry << 10) | ((uint16_t)rxcrypt << 8) | ((uint16_t)stopmod << 7) | ((uint16_t)nullflt << 6) | ((uint16_t)txeir << 3) | ((uint16_t)txbcry << 2) | ((uint16_t)txcrypt << 0));
}

__INLINE void em_bt_txrxcntl_unpack(int elt_idx, uint8_t* rxthr, uint8_t* rxeir, uint8_t* rxbcry, uint8_t* rxcrypt, uint8_t* stopmod, uint8_t* nullflt, uint8_t* txeir, uint8_t* txbcry, uint8_t* txcrypt)
{
...
__INLINE void em_bt_e_scotxrxstat_pack(int elt_idx, uint8_t escorsvd, uint8_t escoretx, uint8_t escowaitack, uint8_t escolastack, uint8_t escolastseqn)
{
    ...
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,  ((uint16_t)escorsvd << 9) | ((uint16_t)escoretx << 8) | ((uint16_t)escowaitack << 2) | ((uint16_t)escolastack << 1) | ((uint16_t)escolastseqn << 0));
}
...
{
    ASSERT_ERR((((uint16_t)escorsvd << 9) & ~((uint16_t)0x00000200)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000200)) | ((uint16_t)escorsvd << 9));
}
...
{
    ASSERT_ERR((((uint16_t)escoretx << 8) & ~((uint16_t)0x00000100)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000100)) | ((uint16_t)escoretx << 8));
}
...
{
    ASSERT_ERR((((uint16_t)escowaitack << 2) & ~((uint16_t)0x00000004)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000004)) | ((uint16_t)escowaitack << 2));
}
...
{
    ASSERT_ERR((((uint16_t)escolastack << 1) & ~((uint16_t)0x00000002)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000002)) | ((uint16_t)escolastack << 1));
}
...
{
    ASSERT_ERR((((uint16_t)escolastseqn << 0) & ~((uint16_t)0x00000001)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000001)) | ((uint16_t)escolastseqn << 0));
}
