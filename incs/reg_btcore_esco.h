...
#define REG_BTCORE_ESCO_COUNT 124

#define REG_BTCORE_ESCO_DECODING_MASK 0x000001FF
...
{
    ASSERT_ERR((((uint32_t)escoptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE, (REG_BT_RD(BT_E_SCOCURRENTTXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)escoptrtx1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)escoptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE, (REG_BT_RD(BT_E_SCOCURRENTTXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)escoptrtx0 << 0));
}
...
{
    ASSERT_ERR((((uint32_t)escoptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE, (REG_BT_RD(BT_E_SCOCURRENTRXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)escoptrrx1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)escoptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE, (REG_BT_RD(BT_E_SCOCURRENTRXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)escoptrrx0 << 0));
}
