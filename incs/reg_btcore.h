...
__INLINE void bt_rwbtconf_unpack(uint8_t* dmmode, uint8_t* correlator, uint8_t* mwswci2, uint8_t* mwswci1, uint8_t* vxportnb, uint8_t* pcm, uint8_t* mwscoex, uint8_t* wlancoex, uint8_t* rfif, uint8_t* usedbg, uint8_t* decipher, uint8_t* clksel, uint8_t* intmode, uint8_t* bustype, uint8_t* datawidth, uint8_t* addrwidth)
{
...
__INLINE void bt_intcntl_pack(uint8_t clknintsrmsk, uint8_t clknintsrval, uint8_t mwswcirxintmsk, uint8_t mwswcitxintmsk, uint8_t mtoffint1msk, uint8_t mtoffint0msk, uint8_t frsyncintmsk, uint8_t audioint2msk, uint8_t audioint1msk, uint8_t audioint0msk, uint8_t swintmsk, uint8_t timestampintmsk, uint8_t finetgtintmsk, uint8_t grosstgtintmsk, uint8_t errorintmsk, uint8_t cryptintmsk, uint8_t skipfrmintmsk, uint8_t endfrmintmsk, uint8_t startfrmintmsk, uint8_t slpintmsk, uint8_t rxintmsk, uint8_t clknintmsk)
{
    ...
    REG_BT_WR(BT_INTCNTL_ADDR,  ((uint32_t)clknintsrmsk << 28) | ((uint32_t)clknintsrval << 24) | ((uint32_t)mwswcirxintmsk << 20) | ((uint32_t)mwswcitxintmsk << 19) | ((uint32_t)mtoffint1msk << 18) | ((uint32_t)mtoffint0msk << 17) | ((uint32_t)frsyncintmsk << 16) | ((uint32_t)audioint2msk << 15) | ((uint32_t)audioint1msk << 14) | ((uint32_t)audioint0msk << 13) | ((uint32_t)swintmsk << 12) | ((uint32_t)timestampintmsk << 11) | ((uint32_t)finetgtintmsk << 10) | ((uint32_t)grosstgtintmsk << 9) | ((uint32_t)errorintmsk << 8) | ((uint32_t)cryptintmsk << 7) | ((uint32_t)skipfrmintmsk << 6) | ((uint32_t)endfrmintmsk << 5) | ((uint32_t)startfrmintmsk << 4) | ((uint32_t)slpintmsk << 3) | ((uint32_t)rxintmsk << 2) | ((uint32_t)clknintmsk << 0));
}

__INLINE void bt_intcntl_unpack(uint8_t* clknintsrmsk, uint8_t* clknintsrval, uint8_t* mwswcirxintmsk, uint8_t* mwswcitxintmsk, uint8_t* mtoffint1msk, uint8_t* mtoffint0msk, uint8_t* frsyncintmsk, uint8_t* audioint2msk, uint8_t* audioint1msk, uint8_t* audioint0msk, uint8_t* swintmsk, uint8_t* timestampintmsk, uint8_t* finetgtintmsk, uint8_t* grosstgtintmsk, uint8_t* errorintmsk, uint8_t* cryptintmsk, uint8_t* skipfrmintmsk, uint8_t* endfrmintmsk, uint8_t* startfrmintmsk, uint8_t* slpintmsk, uint8_t* rxintmsk, uint8_t* clknintmsk)
{
...
__INLINE void bt_intstat_unpack(uint8_t* mwswcirxintstat, uint8_t* mwswcitxintstat, uint8_t* mtoffint1stat, uint8_t* mtoffint0stat, uint8_t* frsyncintstat, uint8_t* audioint2stat, uint8_t* audioint1stat, uint8_t* audioint0stat, uint8_t* swintstat, uint8_t* timestampintstat, uint8_t* finetgtintstat, uint8_t* grosstgtintstat, uint8_t* errorintstat, uint8_t* cryptintstat, uint8_t* skipfrmintstat, uint8_t* endfrmintstat, uint8_t* startfrmintstat, uint8_t* slpintstat, uint8_t* rxintstat, uint8_t* clknintstat)
{
...
__INLINE void bt_intrawstat_unpack(uint8_t* mwswcirxintrawstat, uint8_t* mwswcitxintrawstat, uint8_t* mtoffint1rawstat, uint8_t* mtoffint0rawstat, uint8_t* frsyncintrawstat, uint8_t* audioint2rawstat, uint8_t* audioint1rawstat, uint8_t* audioint0rawstat, uint8_t* swintrawstat, uint8_t* timestampintrawstat, uint8_t* finetgtintrawstat, uint8_t* grosstgtintrawstat, uint8_t* errorintrawstat, uint8_t* cryptintrawstat, uint8_t* skipfrmintrawstat, uint8_t* endfrmintrawstat, uint8_t* startfrmintrawstat, uint8_t* slpintrawstat, uint8_t* rxintrawstat, uint8_t* clknintrawstat)
{
...
__INLINE void bt_intack_pack(uint8_t mwswcirxintack, uint8_t mwswcitxintack, uint8_t mtoffint1ack, uint8_t mtoffint0ack, uint8_t frsyncintack, uint8_t audioint2ack, uint8_t audioint1ack, uint8_t audioint0ack, uint8_t swintack, uint8_t timestampintack, uint8_t finetgtintack, uint8_t grosstgtintack, uint8_t errorintack, uint8_t cryptintack, uint8_t skipfrmintack, uint8_t endfrmintack, uint8_t startfrmintack, uint8_t slpintack, uint8_t rxintack, uint8_t clknintack)
{
    ...
    REG_BT_WR(BT_INTACK_ADDR,  ((uint32_t)mwswcirxintack << 20) | ((uint32_t)mwswcitxintack << 19) | ((uint32_t)mtoffint1ack << 18) | ((uint32_t)mtoffint0ack << 17) | ((uint32_t)frsyncintack << 16) | ((uint32_t)audioint2ack << 15) | ((uint32_t)audioint1ack << 14) | ((uint32_t)audioint0ack << 13) | ((uint32_t)swintack << 12) | ((uint32_t)timestampintack << 11) | ((uint32_t)finetgtintack << 10) | ((uint32_t)grosstgtintack << 9) | ((uint32_t)errorintack << 8) | ((uint32_t)cryptintack << 7) | ((uint32_t)skipfrmintack << 6) | ((uint32_t)endfrmintack << 5) | ((uint32_t)startfrmintack << 4) | ((uint32_t)slpintack << 3) | ((uint32_t)rxintack << 2) | ((uint32_t)clknintack << 0));
}

__INLINE void bt_intack_unpack(uint8_t* mwswcirxintack, uint8_t* mwswcitxintack, uint8_t* mtoffint1ack, uint8_t* mtoffint0ack, uint8_t* frsyncintack, uint8_t* audioint2ack, uint8_t* audioint1ack, uint8_t* audioint0ack, uint8_t* swintack, uint8_t* timestampintack, uint8_t* finetgtintack, uint8_t* grosstgtintack, uint8_t* errorintack, uint8_t* cryptintack, uint8_t* skipfrmintack, uint8_t* endfrmintack, uint8_t* startfrmintack, uint8_t* slpintack, uint8_t* rxintack, uint8_t* clknintack)
{
...
__INLINE void bt_deepslcntl_pack(uint8_t extwkupdsb, uint8_t softwakeupreq, uint8_t deepsleepcorren, uint8_t deepsleepon, uint8_t radiosleepen, uint8_t oscsleepen)
{
    ...
    REG_BT_WR(BT_DEEPSLCNTL_ADDR,  ((uint32_t)extwkupdsb << 31) | ((uint32_t)softwakeupreq << 4) | ((uint32_t)deepsleepcorren << 3) | ((uint32_t)deepsleepon << 2) | ((uint32_t)radiosleepen << 1) | ((uint32_t)oscsleepen << 0));
}

__INLINE void bt_deepslcntl_unpack(uint8_t* extwkupdsb, uint8_t* deepsleepstat, uint8_t* softwakeupreq, uint8_t* deepsleepcorren, uint8_t* deepsleepon, uint8_t* radiosleepen, uint8_t* oscsleepen)
{
...
__INLINE void bt_errortypestat_unpack(uint8_t* samerror, uint8_t* rxbufptrerror, uint8_t* txbufptrerror, uint8_t* rxdescemptyerror, uint8_t* txdescemptyerror, uint8_t* csattnberror, uint8_t* csformaterror, uint8_t* chmaperror, uint8_t* hopunderrunerror, uint8_t* frmcntltimererror, uint8_t* frmcntlemaccerror, uint8_t* frmcntlapfmerror, uint8_t* frmschdlapfmerror, uint8_t* frmschdlentryerror, uint8_t* mwscoexemaccerror, uint8_t* pcmemaccerror, uint8_t* audioemaccerror, uint8_t* radiocntlemaccerror, uint8_t* pktcntlemaccerror, uint8_t* cryptmodeerror, uint8_t* rxcrypterror, uint8_t* txcrypterror)
{
...
__INLINE void bt_rftestcntl_pack(uint8_t infiniterx, uint8_t sserrren, uint8_t herrren, uint8_t infinitetx, uint8_t prbstype, uint8_t txpldsrc)
{
    ...
    REG_BT_WR(BT_RFTESTCNTL_ADDR,  ((uint32_t)infiniterx << 31) | ((uint32_t)sserrren << 17) | ((uint32_t)herrren << 16) | ((uint32_t)infinitetx << 15) | ((uint32_t)prbstype << 13) | ((uint32_t)txpldsrc << 12));
}
