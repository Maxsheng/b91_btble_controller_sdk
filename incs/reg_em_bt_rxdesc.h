...
#define REG_EM_BT_RXDESC_COUNT 7
...
{
    ASSERT_ERR((((uint16_t)nextptr << 0) & ~((uint16_t)0x00007FFF)) == 0);
    EM_BT_WR(EM_BT_RXPTR_ADDR + elt_idx * REG_EM_BT_RXDESC_SIZE, (EM_BT_RD(EM_BT_RXPTR_ADDR + elt_idx * REG_EM_BT_RXDESC_SIZE) & ~((uint16_t)0x00007FFF)) | ((uint16_t)nextptr << 0));
}
