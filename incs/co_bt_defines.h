...
//byte26
#define BLE_LE_SET_SC_RSP_DATA_CMD  0//0x01
...
#define BLE_LE_ENCRYPT_CMD          0//0x40
#define BLE_LE_RAND_CMD             0//0x80
//byte28
#define BLE_LE_START_ENC_CMD        0//0x01
#define BLE_LE_LTK_REQ_RPLY_CMD     0//0x02
#define BLE_LE_LTK_REQ_NEG_RPLY_CMD 0//0x04
...
//byte32
#define BLE_RD_AUTH_PAYL_TO_CMD     0//0x10
#define BLE_WR_AUTH_PAYL_TO_CMD     0//0x20


//byte33
#define BLE_LE_REM_CON_PARA_REQ_RPLY_CMD        0//0x10
#define BLE_LE_REM_CON_PARA_REQ_NEG_RPLY_CMD    0//0x20
...
#define BLE_LE_RD_LOC_P256_PUB_KEY_CMD          0//0x02
#define BLE_LE_GEN_DH_KEY_CMD                   0//0x04
#define BLE_LE_ADD_DEV_TO_RESOLV_LIST_CMD       0//0x08
#define BLE_LE_REM_DEV_FROM_RESOLV_LIST_CMD     0//0x10
#define BLE_LE_CLEAR_RESOLV_LIST_CMD            0//0x20
#define BLE_LE_RD_RESOLV_LIST_SIZE_CMD          0//0x40
#define BLE_LE_RD_PEER_RESOLV_ADDR_CMD          0//0x80

//byte35
#define BLE_LE_RD_LOCAL_RESOLV_ADDR_CMD         0//0x01
#define BLE_LE_SET_ADDR_RESOL_CMD               0//0x02
#define BLE_LE_SET_RESOLV_PRIV_ADDR_TO_CMD      0//0x04
...
#define BLE_LE_SET_ADV_SET_RAND_ADDR_CMD        0//0x02
#define BLE_LE_SET_EXT_ADV_PARAM_CMD            0//0x04
#define BLE_LE_SET_EXT_ADV_DATA_CMD             0//0x08
#define BLE_LE_SET_EXT_SCAN_RSP_DATA_CMD        0//0x10
#define BLE_LE_SET_EXT_ADV_EN_CMD               0//0x20
#define BLE_LE_RD_MAX_ADV_DATA_LEN_CMD          0//0x40
#define BLE_LE_RD_NB_SUPP_ADV_SETS_CMD          0//0x80
//byte37
#define BLE_LE_RMV_ADV_SET_CMD                  0//0x01
#define BLE_LE_CLEAR_ADV_SETS_CMD               0//0x02
#define BLE_LE_SET_PER_ADV_PARAM_CMD            0//0x04
#define BLE_LE_SET_PER_ADV_DATA_CMD             0//0x08
#define BLE_LE_SET_PER_ADV_EN_CMD               0//0x10
#define BLE_LE_SET_EXT_SCAN_PARAM_CMD           0//0x20
#define BLE_LE_SET_EXT_SCAN_EN_CMD              0//0x40
#define BLE_LE_EXT_CREATE_CON_CMD               0//0x80
//byte38
#define BLE_LE_PER_ADV_CREATE_SYNC_CMD          0//0x01
#define BLE_LE_PER_ADV_CREATE_SYNC_CANCEL_CMD   0//0x02
#define BLE_LE_PER_ADV_TERM_SYNC_CMD            0//0x04
#define BLE_LE_ADD_DEV_TO_PER_ADV_LIST_CMD      0//0x08
#define BLE_LE_RMV_DEV_FROM_PER_ADV_LIST_CMD    0//0x10
#define BLE_LE_CLEAR_PER_ADV_LIST_CMD           0//0x20
#define BLE_LE_RD_PER_ADV_LIST_SIZE_CMD         0//0x40
...
#define MASTER_ROLE             0 // we set as master in all acl link 
#define SLAVE_ROLE              1 // we set as slave  in all acl link 
#define MASTER_SLAVE_ROLE       2 // we set as maser when connected with headset,  set as slave when  connected with  pc or phone
#define MASTER_SLAVE_ROLE_NOT_SET       3// we not specified master or slave in any acl link
...
#define SNIFF_INTERVAL_MAX      0x0640
...
#define AUTO_FLUSH_TIMEOUT_DFT  96
...
#define LSTO_TRANSITION         0x0640      // transition parameter used during baseband page procedure from unconnectted to connectted
...
#define BT_AFH_RSSI_INTERF_THR       (30)
...
#define BT_AFH_ASSESS_VALID_TO       0x3200
...
}__attribute__ ((__packed__)) lap_t;
...
} __attribute__ ((__packed__))  devclass_t;
...
}__attribute__ ((__packed__)) eir_t;
...
typedef struct remote_name_cmd
{
    ///BdAddr
    struct bd_addr  bd_addr;
    ///Page Scan Repetition Mode
    uint8_t         pg_sc_rep_mode;
    ///Reserved
    uint8_t         rsvd;
    ///Clock Offset
    uint16_t        clk_off;
} __attribute__ ((__packed__)) remote_name_cmd_t;
