...
#define REG_BTCORE_AUDIO_COUNT 141
 ...
 * </pre>
 */
#define BT_AUDIOCNTL_ADDR   (REG_BTCORE_BASE_ADDR+0x230)
#define BT_AUDIOCNTL_OFFSET 0x00000230
#define BT_AUDIOCNTL_INDEX  0x0000008C
