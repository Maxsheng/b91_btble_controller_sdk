...
#ifdef		MYUDB_DISABLE //if define MYUDB_DISABLE ->disable usb vcd/print function by qipeng 2021.11.12

#define HCI_USB_ID_VENDOR					0x248a			// for report
#define HCI_USB_ID_PRODUCT					0x9218
#define HCI_USB_ID_VERSION					0x0101
#define HCI_USB_STRING_VENDOR				L"Telink"
#define HCI_USB_STRING_PRODUCT				L"HCI controller Dongle"
#define HCI_USB_STRING_SERIAL				L"TLSR9218"

#define	HCI_USB_EDP_IN_INTERRUPT		1
#define	HCI_USB_EDP_IN_BULK				3
#define	HCI_USB_EDP_OUT_BULK			5
#define	HCI_USB_EDP_IN_ISO				7
#define	HCI_USB_EDP_OUT_ISO				6

//endpoint size
#define	HCI_USB_CONTROL_SIZE			8
#define HCI_USB_BULK_SIZE				32
#define HCI_USB_INTERRUPT_SIZE			16
//#define	HCI_USB_ISO_SIZE				17
 ...
 */
#define USB_STRING_LEN(UnicodeChars)      (sizeof(HCI_USB_Descriptor_Header_t) + ((UnicodeChars) << 1))
...
typedef struct
{
	HCI_USB_Descriptor_Header_t Header; /**< Descriptor header, including type and size. */
...
}HCI_USB_StdDescriptor_Devicequalifier_t;
...
typedef struct
{
	...
	u8  MaxPowerConsumption; /**< Maximum power consumption of the device while in the
	                               ...
	                               *   macro.
	                               */
}__attribute__((packed)) HCI_USB_Descriptor_Configuration_Header_t;
...
}__attribute__((packed))HCI_USB_Descriptor_Interface_t;
...
typedef struct
{
	...
	u8 IADStrIndex; /**< Index of the string descriptor describing the
	                      ...
	                      */
}HCI_USB_Descriptor_Interface_Association_t;
...
typedef struct
{
	...
	u8  PollingIntervalMS; /**< Polling interval in milliseconds for the endpoint if it is an INTERRUPT
	                             *   or ISOCHRONOUS type.
	                             */
}__attribute__((packed)) HCI_USB_Descriptor_Endpoint_t;
...
enum {
	HCI_USB_STRING_LANGUAGE_ID = 0,
	HCI_USB_STRING_VENDOR_ID,
	HCI_USB_STRING_PRODUCT_ID,
	HCI_USB_STRING_SERIAL_ID,
};

typedef struct {
	HCI_USB_Descriptor_Configuration_Header_t Config;
	HCI_USB_Descriptor_Interface_t intf0;
	HCI_USB_Descriptor_Endpoint_t endpi0;
	HCI_USB_Descriptor_Endpoint_t endpi1;
	HCI_USB_Descriptor_Endpoint_t endpo0;
	HCI_USB_Descriptor_Interface_t intf1;
	HCI_USB_Descriptor_Endpoint_t endpo1;
	HCI_USB_Descriptor_Endpoint_t endpi2;

	HCI_USB_Descriptor_Interface_t intf1_alternate1;
	HCI_USB_Descriptor_Endpoint_t endpo1_alternate1;
	HCI_USB_Descriptor_Endpoint_t endpi2_alternate1;

	HCI_USB_Descriptor_Interface_t intf1_alternate2;
	HCI_USB_Descriptor_Endpoint_t endpo1_alternate2;
	HCI_USB_Descriptor_Endpoint_t endpi2_alternate2;

	HCI_USB_Descriptor_Interface_t intf1_alternate3;
	HCI_USB_Descriptor_Endpoint_t endpo1_alternate3;
	HCI_USB_Descriptor_Endpoint_t endpi2_alternate3;

	HCI_USB_Descriptor_Interface_t intf1_alternate4;
	HCI_USB_Descriptor_Endpoint_t endpo1_alternate4;
	HCI_USB_Descriptor_Endpoint_t endpi2_alternate4;

	HCI_USB_Descriptor_Interface_t intf1_alternate5;
	HCI_USB_Descriptor_Endpoint_t endpo1_alternate5;
	HCI_USB_Descriptor_Endpoint_t endpi2_alternate5;

} HCI_USB_Descriptor_Configuration_t;
...
// usb vcd/print function by qipeng 2021.11.12
#else
