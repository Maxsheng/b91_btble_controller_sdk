...
#define			SLEV_tsync_rx_valid 					14
#define			SLEV_tsync_btr_done						14
#define			SLEV_tsync_btr_timeout					14
#define			SLEV_tsync_btr_1st_timeout				14
#define			SLEV_tsync_xcap_set						14
#define			SLEV_tsync_miss_wptr					14
#define			SLEV_tsync_miss_sample					14
#define			SLEV_tsync_miss_buff_empty				14
#define			SLEV_tsync_buff_overflow				14
#define			SLEV_tsync_mute_low						14

#define			SLEV_tmusic_audio_st					14
#define			SLEV_tmusic_sync_init					14
...
#define			SL01_task_esco					10

#define			SL01_schedule_add				11
#define			SL01_schedule_sel				12
#define			SL01_schedule_keep				13
#define			SL01_schedule_end				14

//#define			SL01_bt_arqn_nak	         	15
//#define			SL01_bt_flow_stop    	     	16
#define			SL01_task_pa_rx					15
#define			SL01_task_pa_tx					16
#define			SL01_task_ec_spk				17
#define			SL01_task_ec_mic				18

#define			SL01_task_ble_stimer   			19
#define			SL01_task_ble_rx		   		20
#define			SL01_task_ble_btx				21
#define			SL01_task_ble_brx				22

#define			SL01_task_music_enc				23
#define			SL01_task_music_dec				24
#define			SL01_task_music_rate_change		25
#define			SL01_task_music_play_mute		26

#define			SL01_task_tws_arbiter_en    	27
#define			SL01_task_tws_observer_en  		28

#define			SL01_task_kwd_data_in			29
#define			SL01_task_kwd_Process           30
#define			SL01_task_kwd_awaken			31

// 8-bit data: cid0 - cid63
#define			SL08_lmp_rx_code				0
#define			SL08_lmp_esc4					1
#define			SL08_bt_inq_rx					2
#define			SL08_bt_reset					3
#define			SL08_bt_sniff_debug				4
#define			SL08_bt_acl_link_id				5
#define			SL08_bt_rsw_state				6
#define			SL08_esco_link_id				7

#define			SL08_tsync_st					8
#define			SL08_tsync_xcap_val				9
#define			SL08_music_sync_play			10


#define			SL08_schedule_cur_priority		13
#define			SL08_schedule_seq				14
#define			SL08_schedule_last_id			15
#define			SL08_page_train					16
#define			SL08_fsm_sts					17
#define         SL08_esco_frm_no                18
#define         SL08_esco_tog                   19
#define         SL08_esco_rx_err                20
#define			SL08_tx_path_delay				21
#define			SL08_tx_arqn_seqn				22
#define			SL08_acl_flow					23
#define			SL08_detach_state				24
#define			SL08_encrypt_state				25
#define			SL08_test_mode					26
#define			SL08_test_dbg					27
#define			SL08_pair_state					28
#define			SL08_authen_state				29
#define			SL08_task_state					30
#define			SL08_txfifo_wptr				31
#define			SL08_txfifo_rptr				32
#define         SL08_ble_chn                    33
#define			SL08_bt_page_en					34
#define			SL08_bt_task_pend				35
#define			SL08_bt_link_dis				36
#define			SL08_afh_state                  37
#define			SL08_afh_cls_state              38
#define			SL08_con_state              	39
#define			SL08_sch_update_next_id         40
#define			SL08_sch_change_next_id         41
...
#define			SL16_tsync_CLKN					23
#define			SL16_tsync_FCNT					24
#define			SL16_tsync_drift				25
#define			SL16_music_samples				26
#define			SL16_music_sample_played		27
#define			SL16_music_sync_sample			28
#define			SL16_music_sample_peer			29
#define			SL16_music_rwptr				30
#define			SL16_ec_rptr					31
#define			SL16_ec_wptr					32
#define			SL16_bt_rsw_slotoffset			33
#define         SL16_bt_sniff_hslot             34
#define         SL16_bt_sniff_prefetch          35
#define         SL16_bt_et_start	            36
#define         SL16_bt_lmp_tx_opcode	        37
